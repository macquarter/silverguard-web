...
(function () {
  ...
  var KB = [
    ...
    { id:"trust", kw:["검증","신뢰","믿","증명","레퍼런스","협약","kbs","방송"],
      a:"신뢰 설계는 다음과 같습니다.<br>• <b>한국노인인력개발원</b> 협약 (운영 모델 검증)<br>• <b>KBS 생로병사의 비밀</b> 방영 (공영방송 사례)<br>• <b>KIPRIS 특허 4건</b> (기술 IP)" },
    { id:"apply", kw:["지원","채용","참여","모집","가입","일자리","합류","지원방법","시니어 지원","일하","활동하"],
      a:"실버가드 시니어 Pro-Agent로 함께하실 수 있습니다. <b>한국노인인력개발원 협약</b> 기반으로 직접 고용해 운영합니다.<br>지원·참여 문의는 👉 <a href='" + MAIL_APPLY + "'>여기로 신청</a> 또는 <b>41quart@gmail.com</b> 으로 연락 주세요." },
